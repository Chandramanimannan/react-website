...
class Website extends Component {
	...
	typeNextWord() {
		...
		if (currentLength < currentWord.length) {
			this.setState({ currentText: currentWord.substring(0, currentLength + 1)});
		} else {
			clearInterval(this.typingInterval);
			setTimeout(() => {
	...
	render() {
		const { navbarColor, isVisible, currentImageIndex, images, aboutimages,isMobileMenuOpen, currentSlide,modalOpen,screen } = this.state;
		...
		return (
			...
			{modalOpen && (
							<Modal
								...
								children={
								<div>
									    {this.handleFooterdata(this.state.screen)}
								</div>
							}
							/>
						)}
				<div id="website">
					...
					<div className="website">
						...
						<nav className={`websiteHeader ${navbarColor === "black" ? "dark-bg" : "light-bg"}`}>
							<div>
								<img src={companyFullLogo} alt="Company logo" className="companylogo"/>
							</div>

							<div className="mobileMenuButton" onClick={this.toggleMobileMenu}>
								<span style={{ backgroundColor: navbarColor === "white" ? "#ffffff" : "#000000" }}></span>
								<span style={{ backgroundColor: navbarColor === "white" ? "#ffffff" : "#000000" }}></span>
								<span style={{ backgroundColor: navbarColor === "white" ? "#ffffff" : "#000000" }}></span>
							</div>
								<div
					...
					{/* -------------------------------------------------------------------------------------------------- */}
						...
						<div className={`about ${isVisible ? "transaction-animation" : "hidden"}`}>
							...
							<div className="features-display-left">
								<div>
									...
									<div className="features-display-left-cards">
										<div className="features-card" onClick={() => this.handleImageClick(0)} >
											<div>
												<span>
													<img
													src={moeny_ic}
										...
										<div className="features-card" onClick={() => this.handleImageClick(1)} >
											<div>
												<span>
													<img
													src={dashboard_ic}
										...
										<div className="features-card" 	onClick={() => this.handleImageClick(3)} >
											<div>
												<span>
													<img
													src={api_ic}
										...
										<div className="features-card" 	onClick={() => this.handleImageClick(2)} >
											<div>
												<span>
													<img
													src={server_ic}
